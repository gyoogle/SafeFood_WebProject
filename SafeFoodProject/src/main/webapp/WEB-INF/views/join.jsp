...
<body>
	...
	<!-- 회원가입 틀------------------------------------------------------------------------ -->
	<form action="joinSuccess.safefood" role="form" method="post">
			...
			<br>
				<div class="container" id="inputId">
					...
					<div class="input-group" style="width: 570px;">
						<input type="text" class="form-control" placeholder="아이디를 입력하시오." name="id"
							aria-label="아이디를 입력하시오." aria-describedby="basic-addon2">
				...
				<div class="container" id="inputId">
					<div class="input-group" style="width: 230px;" id="fleft">
						...
						<input type="password" class="form-control" placeholder="●●●●●●●●" name="password"
							aria-label="●●●●●●●●" aria-describedby="basic-addon2" id="Pw">
					</div>
					...
					<div class="input-group" style="width: 230px; margin-left: 70px;"
						...
						<input type="password" class="form-control" placeholder="●●●●●●●●"
							aria-label="●●●●●●●●" aria-describedby="basic-addon2" id="PwCheck">
					</div>
					...
					<div class="container">
						<div class="container">
							<div class="input-group" style="width: 200px;" id="fleft">
								<h4>이름</h4>
								<input type="text" class="form-control" placeholder="이름을 입력하시오." name="name"
									aria-label="이름을 입력하시오." aria-describedby="basic-addon2">
							</div>
						...
						<div class="container">
							<div class="input-group" style="width: 500px;" id="fleft">
								<h4>핸드폰 번호</h4>
								<input type="tel" class="forㄴm-control"
						...
						<button type="submit" class="btn btn-info btn-lg"
							style="margin-top: 30px; margin-left: 480px;">가입 완료</button>
				</div>
			</div>
			<br>
			<hr style="border: 1px solid gray">
